  ...
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        <div>
          <p className="text-xs text-shadow-slate-400 uppercase tracking-wider mb-1">Employee Name</p>
          <p className="font-semibold text-slate-900">{payslip.employee?.firstName} {payslip.employee?.lastName}</p>
        </div>
        <div>
          <p className="text-xs text-shadow-slate-400 uppercase tracking-wider mb-1">Position</p>
          <p className="font-semibold text-slate-900">{payslip.employee?.position}</p>
        </div>
        <div>
          <p className="text-xs text-shadow-slate-400 uppercase tracking-wider mb-1">Email</p>
          <p className="font-semibold text-slate-900">{payslip.employee?.email}</p>
        </div>
        <div>
          <p className="text-xs text-shadow-slate-400 uppercase tracking-wider mb-1">Period</p>
