...
const EmployCard = ({employee , onDelete , onEdit}) => {
    ...
    <div className="group relative card card-hover overflow-hidden ">
        ...
        {!employee.isDeleted && (
            ...
            transition-opacity flex items-end justify-center pb-6 gap-3">
                ...
                <button onClick={handleDelete} className="p-2.5 bg-white/90 backdrop-blur-sm text-slate-700 hover:text-rose-600 rounded-xl shadow-lg transition-all 
